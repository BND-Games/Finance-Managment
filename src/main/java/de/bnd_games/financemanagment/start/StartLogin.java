			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addComponent(lblLogin, GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addComponent(lblPasswort, GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
						...
						.addComponent(btnPasswortVergessen, GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
						.addComponent(btnLogin, GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE))
					.addContainerGap())
		);
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(19)
							.addComponent(lblLogin, GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)
							.addGap(18)
