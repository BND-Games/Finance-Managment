...
public class MD5Generator {
	...
	public String main(String message) {
		...
		{
	    	System.err.println("[Fehler] Generieren des MD5 Wertes von " + message + " ist Fehlgeschlagen.");
	    	return "failed";
		}
		finally
		{
	    	System.out.println("[Konsole] MD5 Wert von: " + message + "erfolgreich erstellt.");
